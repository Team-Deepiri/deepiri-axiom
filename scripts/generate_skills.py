...
Multi-agent coordination via shared journal files — not ad-hoc copy-paste between chats.""",
    ...
    (
        "deepiri-sorge",
        "Deepiri Sorge AI PR review bot — /sorge comments, workflows, sorge.toml. Use when reviewing PRs, triggering Sorge, wiring PR automation, or when the user mentions sorge, /sorge, or AI code review.",
