...
- **Platform / TS services:** `deepiri-control-plane` (local monorepo), `deepiri-platform` (cloud portal), `deepiri-api-gateway`, `deepiri-core-api`, `deepiri-auth-service`, `deepiri-external-bridge-service`, `deepiri-language-intelligence-service`, `deepiri-web-frontend`, `deepiri-landing`, `deepiri-shared-utils`.
