...
## Order
1. Clone `deepiri-control-plane` (local/lab) or `deepiri-platform` (cloud portal) and relevant service repos; `./setup.sh` from `deepiri-axiom` for agent/skill install.
